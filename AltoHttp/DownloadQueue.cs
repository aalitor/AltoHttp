...
{
    /// <summary>
    /// Occurs when a queue element is completed
    /// </summary>
    ...
    public class DownloadQueue : IQueue, IDisposable
    {
        ...
        /// <summary>
        /// Occurs when a queue element download process has been started
        /// </summary>
        ...
        /// <summary>
        /// Gets the boolean value to check if the current download process supports ranges
        /// </summary>
