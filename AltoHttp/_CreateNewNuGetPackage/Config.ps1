...
$releaseNotes = "Modifying request and response using events is enabled"
...
$projectUrl = "https://github.com/aalitor/AltoHttp"

$tags="http fast easy download management queue"
